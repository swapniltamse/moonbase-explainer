...
| All data in one file (`assets/data.js`, `assets/refs.js`) | A revised source means editing one file, not hunting through markup | Data is plain JS objects, not a schema-validated format |
